			...
			<div className="max-w-7xl w-full flex flex-col md:flex-row items-center justify-between gap-8 pt-32 pb-25 px-6">
				...
				<div className="flex-1 justify-center items-center">
					...
					<p className="text-gray-500 w-full text-lg mb-8 md:mb-10 md:max-w-md">
						AI-driven personal financial management platform — track spending,
						unlock insights, and optimize your money flow in real time.
					</p>
					<div className="flex items-center justify-center md:justify-start gap-4 mb-6">
						<Link href={"/dashboard"}>
							<Button
								size={"lg"}
								className="bg-linear-to-r from-indigo-600 to-emerald-500 text-white p-6 rounded-full font-semibold hover:brightness-110 transition"
							>
								Get Started
						...
						>
							<Button
								size="lg"
								variant={"outline"}
								className="p-6 cursor-pointer rounded-full transition"
							>
								<Play />
								View Demo
							</Button>
